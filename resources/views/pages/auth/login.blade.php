                ...
                <div class="hidden w-full lg:block lg:w-1/2">
                    <div class="px-26 py-17.5 text-center">
                        <a class="mb-5.5 inline-block" href="index.html">
                            <img src="{{ asset('assets/images/text-logo.png') }}" alt="Logo">
                        </a>
                    </div>
                </div>
                <div class="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2 h-full">
                    <div class="w-full p-4 sm:p-12.5 lg:p-17.5">
                        <span class="mb-1.5 block font-medium">Welcome</span>
