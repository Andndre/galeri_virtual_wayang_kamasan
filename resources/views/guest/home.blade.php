        ...
        <div class="flex flex-col justify-center items-center h-full w-full animate-pop">
            ...
            <div class="flex flex-col justify-center items-center h-full w-full">
                <div class="flex flex-col gap-3">
                    <div
                        class="bg-marun text-white px-12 py-2 rounded-full border-black border-[4px] text-center font-joti">
                        <h3 class="text-2xl">{{ __('app.settings') }}</h3>
                    </div>
                    <div
                        class="flex flex-col bg-marun text-white rounded-3xl border-black border-[4px] text-center font-joti overflow-hidden">
                        ...
                        <a href="{{ route('change-language', 'id') }}" class="bg-cokelat px-6 py-3 flex gap-4 items-center"
                            id="english-button">
                            <img class="w-10 aspect-square" src="{{ asset('assets/img/guest/indonesia.png') }}"
                                alt="">
                        ...
                        <a href="{{ route('change-language', 'en') }}" class="bg-cokelat px-6 py-3 flex gap-4 items-center"
                            id="indonesia-button">
                            <img class="w-10 aspect-square" src="{{ asset('assets/img/guest/english.png') }}"
                                alt="">
    ...
    <div id="info-overlay" class="absolute top-0 left-0 w-full h-full bg-black/85 hidden">
        <div class="flex flex-col justify-center items-center h-full w-full animate-pop">
            <button id="panduan-button"
                class="mt-3 bg-marun font-joti text-white px-6 py-3 rounded-full border-black border-[4px]" id="info-close">
                {{ __('app.guide') }}
            </button>
        </div>
    </div>
